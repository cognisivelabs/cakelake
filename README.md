...
| Payments | Stripe or PayTabs (final pick pending); Apple Pay/Google Pay only online; tap card in person via ADCB | [ADR-006](docs/adr/ADR-006-payment-gateway.md) |
