...
| [ADR-005](ADR-005-customer-identity.md) | Customer Identity — Email or Mobile (via WhatsApp) for Accounts, Email for Guests | Accepted |
| [ADR-006](ADR-006-payment-gateway.md) | Payment Gateway — Stripe or PayTabs, Final Pick Pending | Proposed |
